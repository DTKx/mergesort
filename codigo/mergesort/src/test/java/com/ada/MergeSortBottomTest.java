...
/**
 * Unit test for MergeSortBottom.
 */

public class MergeSortBottomTest {
    ...
    public void testexecuteMergeSort() throws IOException {
        ...
        myArray = MergeSortBottom.executeMergeSort(myArray);
        ...
        myArray2 = MergeSortBottom.executeMergeSort(myArray2);
        ...
        myArray3 = MergeSortBottom.executeMergeSort(myArray3);
        ...
        myArray3_2 = MergeSortBottom.executeMergeSort(myArray3_2);
        ...
        myArray4 = MergeSortBottom.executeMergeSort(myArray4);
        ...
        myArray4_2 = MergeSortBottom.executeMergeSort(myArray4_2);
        ...
        for (int t = 0; t < numTests; t++) {
            ...
            for (int i = 0; i < nValues.length; i++) {
                System.out.println("Start Random Case Bottom" + i);
                int[] array = createRandomSizeNArray(nValues[i]);
                array = MergeSortBottom.executeMergeSort(array);
